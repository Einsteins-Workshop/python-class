...
#
# Using names.txt (https://projecteuler.net/resources/documents/0022_names.txt), a 46K text file
...
# 3+15+12+9+14=53, is in the 938th position in the list. So COLIN would obtain a score of
# 938 X 42 = 49714.
#
