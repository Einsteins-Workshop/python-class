...
primes = [2, 3, 5, 7]
print("Printing each of the primes")
for prime in primes:
    print(prime)
...
print("Showing an enumerate of a list")
...
number = 0
print("Demonstrating a while loop starting at 0, not exceedinng 50")
while number < 50:
    print(number)
    number = number + 10
...
print("Printing all numbers in range(20) that are not divisible by 2 or 3")
