...
def start_game():
    # TODO: Create a grid that represents the starting position.  It should be a list of lists where each sublist has
    # 4 elements.  Each element of the sublists should be 0.
    grid = []
